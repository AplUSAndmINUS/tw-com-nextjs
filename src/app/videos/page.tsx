...
// TODO: Implement the video listing page with real data from the YouTube API. This will require setting up an Azure Function (api/videos) to fetch and cache video data, and then replacing the static placeholder videos with real data at runtime. -TW
// const series = [
//   {
